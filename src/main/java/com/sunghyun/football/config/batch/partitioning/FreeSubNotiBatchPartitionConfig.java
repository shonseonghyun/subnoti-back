...
public class FreeSubNotiBatchPartitionConfig {
    ...
    public TaskExecutorPartitionHandler partitionHandler() {
        ...
        partitionHandler.setStep(freeSubNotiPartitionStep()); // (2)
    ...
    @Bean
    public Step stepManager(PlatformTransactionManager transactionManager,JobRepository jobRepository){
...
//    }
    ...
    public Step freeSubNotiPartitionStep(PlatformTransactionManager transactionManager, JobRepository jobRepository){
        return new StepBuilder("freeSubNotiPartitionStep",jobRepository)
                ...
                .reader(freeSubNotiPartitionReader(null))
...
//                .throttleLimit(4)
    ...
    @Bean
    @StepScope
    public AbstractPagingItemReader<FreeSubNotiEntity> freeSubNotiPartitionReader(@Value("#{jobParameters[nowDt]}") String nowDt){
