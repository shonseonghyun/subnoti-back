...
import com.sunghyun.football.config.batch.partitioning.NewFreeSubNotiBatchPartitionConfig;
...
public class SchedulerConfig {
    ...
    private final NewFreeSubNotiBatchPartitionConfig newFreeSubNotiBatchPartitionConfig;
//    private final FreeSubNotiBatchPartitionConfig freeSubNotiBatchPartitionConfig;
    ...
    public void freesubNotiRegScheduler() throws JobInstanceAlreadyCompleteException, JobExecutionAlreadyRunningException, JobParametersInvalidException, JobRestartException {
        ...
        JobParameters jobParameters= new JobParametersBuilder()
                .addString("startDt", MatchDateUtils.getNowDtStr())
                .addLong("time",new Date().getTime()) //여러번 돌수 있게 세팅
                .toJobParameters();

        jobLauncher.run(newFreeSubNotiBatchPartitionConfig.newFreeSubNotiBatchPartitionJob(jobRepository, manager),jobParameters);
